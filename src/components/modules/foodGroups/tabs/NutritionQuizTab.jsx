...
import { quizQuestions, shuffleArray } from '../../../../data/foodGroupsData';

const NutritionQuizTab = () => {
  ...
  const startQuiz = () => {
    ...
    setHasStarted(true);
    playSound('success');
    speak('Let\'s test your food group knowledge!');
  };
  ...
  const handleNext = () => {
    ...
    if (currentIndex < questions.length - 1) {
      ...
      if (percentage === 100) {
        speak('Perfect score! You\'re a nutrition expert!');
      } else if (percentage >= 80) {
        speak('Excellent job! You know a lot about food groups!');
      } else if (percentage >= 60) {
        speak('Good work! Keep learning about healthy eating!');
      } else {
        speak('Nice try! Practice more to become a nutrition pro!');
      }
    }
  };
    ...
    return (
      <div className="min-h-[50vh] max-h-[calc(100vh-140px)] flex items-center justify-center p-6">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-white mb-4">Nutrition Quiz</h2>
          <p className="text-xl text-white/80 mb-8">
            Test your knowledge about food groups and healthy eating!
          </p>
          <motion.button
            onClick={startQuiz}
      ...
      <div className="min-h-[50vh] max-h-[calc(100vh-140px)] flex items-center justify-center p-6">
        ...
        >
          ...
          <h3 className="text-4xl font-bold text-white mb-4">
            {percentage === 100 ? 'Perfect Score!' : percentage >= 80 ? 'Excellent!' : percentage >= 60 ? 'Good Job!' : 'Keep Learning!'}
          </h3>
        ...
        <div className="flex-1 flex items-center justify-center">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Question */}
              <motion.div 
                className="bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl mb-6 text-center"
...
export default NutritionQuizTab;
