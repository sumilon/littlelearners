...
const tabs = [
  { id: 'animals', label: '🦁', component: AnimalsTab, title: 'Animals' },
  { id: 'plants', label: '🌱', component: PlantsTab, title: 'Plants' },
  { id: 'seasons', label: '🌦️', component: SeasonsTab, title: 'Seasons' },
  { id: 'habits', label: '♻️', component: HabitsTab, title: 'Good Habits' }
];

export default function EVSModule({ onBack }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-400 via-emerald-400 to-teal-400 px-4 pb-6">
      {/* Header */}
      <motion.div 
        className="sticky top-[70px] left-0 right-0 bg-gradient-to-r from-green-500 to-teal-500 text-white p-4 shadow-lg z-40 flex items-center justify-between"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      >
        <button
